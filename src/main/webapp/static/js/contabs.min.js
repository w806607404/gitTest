$(function() {
    ...
    function n() {
        ...
        }), n) {//选项卡中没有点击的菜单标签就新增一个菜单对应的标签
			//新建选项卡标签
        	
        	var asdf = t.split("=")[1];
            var s = '<a href="javascript:;" id="ifr_' + asdf + '" class="active J_menuTab" data-id="' + t + '">' + i + ' <i class="fa fa-times-circle"></i></a>';
            $(".J_menuTab").removeClass("active");
            //新建iframe并加载url请求
			var r = '<iframe class="J_iframe" name="iframe' + a + '" width="100%" height="100%" src="' + t + '&v=1.0" frameborder="0" data-id="' + t + '" seamless></iframe>';
			//隐藏所有iframe并追加新的iframe
