...
S2.define('select2/selection/search',[
  ...
  Search.prototype.render = function (decorated) {
    var $search = $(
      '<li style="z-index:9999;" class="select2-search select2-search--inline">' +
        '<input style="z-index:9999;" class="select2-search__field" placeholder="search keyword..." type="search" tabindex="-1"' +
...
S2.define('select2/dropdown/search',[
  ...
  Search.prototype.render = function (decorated) {
    ...
    var $search = $(
      '<span style="z-index:9999;" class="select2-search select2-search--dropdown">' +
        '<input style="z-index:9999;" class="select2-search__field" placeholder="search keyword..."  type="search" tabindex="-1"' +
        ' autocomplete="off" autocorrect="off" autocapitalize="off"' +
        ' spellcheck="false" role="textbox" />' +
      '</span>'
