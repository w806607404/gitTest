...
function SmoothlyMenu() {
	...
	($("body").hasClass("fixed-sidebar") ? ($("#side-menu").hide(), setTimeout(function(){$("#side-menu").fadeIn(500)
...
$(document).ready(function() {
	...
	//滚动条处理 http://danqingyu.com/152.html  更多配置说明
    $(".sidebar-container").slimScroll({
        height: "100%",//容器高度,默认250px
        railOpacity: .4,//滚动条背景轨迹透明度,默认0.2
