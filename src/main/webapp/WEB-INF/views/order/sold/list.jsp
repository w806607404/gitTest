		...
		<div class="panel-body">
			<form id="formSearch" class="form-horizontal">
					...
					<div class="col-sm-1 btn_query">
						<button type="button" id="btn_query_sold" class="btn btn-primary"><spring:message code='font.framework.search'/></button>
					</div>
				</div>
			</form>
		</div>
...
$(function() {
	...
	pageTable = $ScinanPageTable_({
		$id:$('#soldList'),
    	url: "${ctx}/sold/fetchSoldByPage.shtml",//请求url
	...
	//查询按钮
    $('#btn_query_sold').click(function(){
    	pageTable.refreshPage();
	});
	
	
	//删除比例信息
	$('#btn_1005001003').click(function(){
		...
		$ScinanSwal.confirm({
			...
			var obj = CommnUtil.ajax("${ctx}/sold/delSold.shtml",{id:data[0].id},"json");
    		if(obj.status == 200){
