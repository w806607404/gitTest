...
<div class="panel-body" style="padding-bottom:0px;">
	...
	<form id="addForm" name="form" class="form-horizontal" method="post" action="${ctx}/finance/addRatio.shtml">
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<div class="col-sm-8">
					<select id="device_type_id" name="device_type_id" tabindex="-1" class="form-control" >
					    <option value=''>请选择产品类型</option>
						<c:forEach items="${typeList}" var="key">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" placeholder="请填写产品单价（必填）" class="form-control"  name="product_price" id="product_price" maxlength="32">
				</div>
			</div>
			<div class="form-group">
					<label class="col-sm-3 control-label">代理商分成比例</label>
				<div class="col-sm-8">
					<input type="text" placeholder="请填写代理商分成比例（必填）" class="form-control"  name="agent_ratio" id="agent_ratio" maxlength="32">
				</div>
			</div>
			<div class="form-group">
					<label class="col-sm-3 control-label">经销商分成比例</label>
				<div class="col-sm-8">
					<input type="text" placeholder="请填写经销商分成比例（必填）" class="form-control"  name="dealer_ratio" id="dealer_ratio" maxlength="16">
				</div>
			</div>
			<div class="form-group">
					<label class="col-sm-3 control-label">运费补贴比例</label>
				<div class="col-sm-8">
					<input type="text" placeholder="请填写运费补贴比例（必填）" class="form-control"  name="primage_ratio" id="primage_ratio" maxlength="16">
				</div>
			</div>
