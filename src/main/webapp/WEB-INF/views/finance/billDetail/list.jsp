		...
		<div class="panel-body">
			<form id="formSearch" class="form-horizontal">
					...
					<div class="col-sm-1 btn_query">
						<button type="button" id="btn_query_bill_detail" class="btn btn-primary"><spring:message code='font.framework.search'/></button>
					</div>
					</div>
...
$(function() {
	...
	pageTable = $ScinanPageTable_({
		$id:$('#billDetailList'),
    	url: "${ctx}/billDetail/fetchBillDetailByPage.shtml",//请求url
	...
	//查询按钮
    $('#btn_query_bill_detail').click(function(){
